...
SampleMapPath = "/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/data/MappingRNASeq.txt"
GeneNameMapPath = "/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/data/GeneNamesPreliminary.csv"
RNACountsPath = "/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/XanthinPaperFigures/RNAseqInputs/RNACounts.rda"
bamdirpath = "/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/data/bams/"
GTFPath = "/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/XanthinPaperFigures/RNAseqInputs/SA925_ref.gff"
StressGeneMap = "XanthinPaperFigures/RNAseqInputs/StressResponseGenesInclude.csv"
...
MeltedToxins = MeltedToxins %>% mutate(ptext = case_when(padj < .05 & padj >= .01 ~"*", 
                                                         ...
                                                         TRUE~ ""))
ggplot(MeltedToxins, aes(x=Comparison, y=GeneAdjust, fill=log2FoldChange)) + geom_tile() + scale_fill_gradient2(high="red", mid="white", low="blue", midpoint = 0) + geom_text(aes(label=ptext)) + theme_classic() + labs(fill="log2FC") + ylab("Gene")
...
ToxinHeatMap$data$Comparison = factor(ToxinHeatMap$data$Comparison, levels=c("SA925_SA1088_Control", "SA925_SA1088_Stress", "SA1088_Stress", "SA925_Stress"))
