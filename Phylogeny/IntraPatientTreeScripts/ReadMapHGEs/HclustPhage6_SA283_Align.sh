...
outputcounts=HclustPhage6_SA283_Coverage.txt
touch $outputcounts
...
IndexName="HclustPhage6_SA283"

markerpath=/home/acampbe/DFU/data/WGS_2020/PhagePlasmidMapping/Markers/HclustPhage6_SA283.fasta
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN283trimmedgalore_val_2.fastq
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN300trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN280trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
