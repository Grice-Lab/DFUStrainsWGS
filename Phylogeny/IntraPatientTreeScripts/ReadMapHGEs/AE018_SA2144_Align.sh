...
outputcounts=AE018_SA2144_Coverage.txt
touch $soutputcounts
...
IndexName="AE018_SA2144"

markerpath=/home/acampbe/DFU/data/WGS_2020/PhagePlasmidMapping/Markers/AE018_SA2144.fasta
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN2144trimmedgalore_val_2.fastq
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN2089trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN2187trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN2123trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN2083trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
