...
outputcounts=HclustPhage2_SA1219_Coverage.txt
touch $outputcounts
...
IndexName="HclustPhage2_SA1219"

markerpath=/home/acampbe/DFU/data/WGS_2020/PhagePlasmidMapping/Markers/HclustPhage2_SA1219.fasta
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1219trimmedgalore_val_2.fastq
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1253trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1207trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
