...
outputcounts=AH207_SA1593_Coverage.txt
touch $soutputcounts
...
IndexName="AH207_SA1593"

markerpath=/home/acampbe/DFU/data/WGS_2020/PhagePlasmidMapping/Markers/AH207_SA1593.fasta
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1593trimmedgalore_val_2.fastq
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1575trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1572trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1567trimmedgalore_val_2.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
