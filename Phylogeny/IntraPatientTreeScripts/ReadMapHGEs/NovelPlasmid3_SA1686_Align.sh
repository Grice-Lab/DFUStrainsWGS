...
outputcounts=NovelPlasmid3_SA1686_Coverage.txt
touch outputcounts
...
IndexName="NovelPlasmid3_SA1686"

markerpath=/home/acampbe/DFU/data/WGS_2020/PhagePlasmidMapping/Markers/NovelPlasmid3_SA1686.fasta
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1686trimmedgalore_val_1.fastq
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1657trimmedgalore_val_1.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1755trimmedgalore_val_1.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1691trimmedgalore_val_1.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
...
readspath2=/project/grice/storage/DFUShortReads2022/trimmedreads/DORN1661trimmedgalore_val_1.fastq
basenamefile=$(basename $readspath1)
noext=${basenamefile/$trimmed1ext/$blank}
bowtie2 -x $IndexName -1 $readspath1 -2 $readspath2 -S $outputpath$noext$samext
samtools sort $outputpath$noext$samext > $outputpath$noext$bamext
