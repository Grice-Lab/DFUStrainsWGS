...
outputpath="/home/acampbe/DFU/data/WGS_2020/Markers141/BTalignments/N1local/"
...
bowtie2 --local -N 0 -D $dvalue -R $rvalue -L $lvalue -i $ival -x $markername -U $readspath -S $iterationkey$samext
samtools view -bS $iterationkey$samext > $iterationkey$bamext
