...
outputpath="/home/acampbe/DFU/data/WGS_2020/SimulateGenomes141/BTalignments/WholeGenomes/"
...
# Build bowtie index
####################
bowtie2-build $genomepath DORN925Test
mv *.bt2 $bowtiepath
...
bowtie2 -N 1 --very-sensitive-local -x DORN925Test -1 $fwdpath -2 $revpath -S $outputpath$genomename$samext
